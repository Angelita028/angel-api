...
scdl = async function (url) {
  ...
  ress = {};
  ress.thumb = $$("div.info:nth-child(3) > img:nth-child(1)").attr("src");
  ress.title = $$("div.info:nth-child(3) > p:nth-child(2)")
    .text()
    .replace("Title:", "");
  ress.duration = $$("div.info:nth-child(3) > p:nth-child(3)")
    .text()
    .replace(/Length\:|Minutes/gi, "")
    .trim();
  ress.quality = $$("div.info:nth-child(3) > p:nth-child(4)")
    .text()
    .replace("Quality:", "");
  ress.url = $$("#download-btn").attr("href");
  if (
    !ress.url &&
    !ress.quality &&
    !ress.duration &&
